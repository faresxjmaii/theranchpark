...
export const hero = {
  ...
  status: "Vendredi • Samedi • Dimanche",
  hours: "17h00 - Minuit",
};
...
export const openingHours = [
  { day: "Vendredi, Samedi & Dimanche", time: "17h00 - Minuit" },
  { day: "Lundi au Jeudi", time: "Fermé (sur réservation)" },
];

export const openingStatusBadge = "Ouvert Ven • Sam • Dim";
